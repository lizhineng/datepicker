    ...
    _createClass(DatePicker, [{
        ...
        value: function _handleSubmit() {
            if (this.options.onSubmit) {
                ...
                var payload = { startDate: startDate
        ...
        value: function _updateHeroTitle() {
            ...
            if (this.options.type == 'year') title.innerText = year.text;else if (this.options.type == 'month') title.innerText = year.text + month.text;else title.innerText = year.text + month.text + day.text;
        }
